  ...
  return (
    ...
    <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
        <form class="w-full max-w-md">
            ...
            <h1 className='text-center mt-4 font-bold text-2xl'>Recuperar Contraseña</h1>
            ...
            <div class="relative flex items-center mt-6">
                ...
                <input type="email" class="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Repeat Email address" />
            </div>
            ...
            <div class="mt-6">
                ...
                <div class="mt-6 text-center ">
                    <a href="/auth" class="text-sm text-blue-500 hover:underline dark:text-blue-400">
