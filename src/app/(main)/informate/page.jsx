...
function Informate() {
    return (
        <main className='flex flex-col px-[24px] pt-[64px] pb-[70px] gap-[30px] lg:px-[150px]'>
            ...
            <News_card img="/second_news.svg" date="Julio 11, 2025"/>
            <News_card img="/first_news.svg" date="Julio 11, 2025"/>
            <News_card img="/third_news.svg" date="Julio 11, 2025"/>
            <News_card img="/fourth_news.svg" date="Julio 11, 2025"/>
        </main>
    )
}
