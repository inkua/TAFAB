...
<section className=' w-[85%] m-auto '>
  ...
  <h2 className='font-extrabold text-text-dark text-2xl  md:text-3xl mt-16'>¿COMO FUNCIONAMOS?</h2>
  ...
  <h3 className='mt-2'>¿Cuáles son nuestros principios?</h3>
  ...
  <h2 className='font-extrabold text-text-dark text-2xl  md:text-3xl mt-16'>¿CÓMO NOS FINANCIAMOS?</h2>
